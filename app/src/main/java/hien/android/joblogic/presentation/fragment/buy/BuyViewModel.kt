...
class BuyViewModel constructor(private val getItemsToBuyUseCase: GetItemsToBuyUseCase) :
    ...
    private val _itemToBuyResponseLiveData = MutableLiveData<List<ItemBuyResponse>>()
    val itemToBuyResponseLiveData: LiveData<List<ItemBuyResponse>> = _itemToBuyResponseLiveData
